...
<>
    ...
    >
        ...
        <Skill name="HTML" x="-20vw" y="2vw" />
          ...
          <Skill name="Graphic Design (Canva and Photoshop)" x="-5vw" y="-10vw" />
          <Skill name="Wordpress Front End Developer" x="20vw" y="6vw" />
          <Skill name="SQL, MongoDB, and PhpmyAdmin" x="0vw" y="12vw" />
          <Skill name="Javascript" x="-20vw" y="-15vw" />
          <Skill name="Android Studio" x="15vw" y="-12vw" />
          <Skill name="Github" x="-35vw" y="-5vw" />
          <Skill name="Basic Game Development (Unity)" x="32vw" y="-5vw" />
